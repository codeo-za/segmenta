// this should come from jasmine-expect/jasmine-matchers.d.ts
//  however that file expects to insert matchers into the jasmine
//  namespace, where jest is being "clever", rebranding jasmine as
//  jest
